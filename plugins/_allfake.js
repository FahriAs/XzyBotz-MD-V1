...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         ...
         [owner[1], await conn.getName(owner[1] + '6285769727113@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'fahrixzofficial@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
